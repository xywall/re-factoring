...
// 01. 반복문 쪼개고 
// 02. 변수 초기화 문장 옮기기 
//     ( 필요에 따라 문장 슬라이드 하고 같이 옮기기 )
// 03 Error! 함수명을 totalAmount로 사용하고싶을땐?
// 03. 임시변수를 함수로 추출하기, 함수명은 일단 아무 이름이나.
// 04. 변수 인라인 
// 05. 함수명 변경, 변수명 변경


function totalAmount(){  // 03. 05.
  let result = 0; // 05.
  for (let perf of invoice.performances){     
...
function statement(invoice, plays){ 
  ...
  // let totalAmount = 0;    // 01. 02.
  for (let perf of invoice.performances){     // 03.
